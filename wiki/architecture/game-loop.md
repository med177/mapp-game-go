...
| `ActionStartSiege` | Kuşatma modalı | Orduda kuşatma birimi varsa tahkimli düşman kara bölgesinde aktif kuşatma başlatır; ordu hedefe girmez, hareketi biter. Başka bir devletin devam eden kuşatmasına destek ayrı `ActionMoveArmy` akışıyla gelir; burada yeni bir kuşatma kaydı açılmaz |
