...
Pozitif merchant filo bonusu üreten donanmalar bu harita modunda rota koridorunun üzerinde/yanında yuvarlak marker ve sarı `+N` rozetle görünür; değer rota kapasitesine göre `+1` ila `+4` olabilir. Marker ile koridor arasındaki connector aynı `TradeRouteKey` eşleşmesinden türetilir.
