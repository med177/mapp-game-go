...
| 6 | Ordu detay paneli — 20 slot ızgarası, boş slotlar silik; dost toprakta toparlanan hasarlı birimler kart köşesinde küçük `+` rozeti taşır; aynı tur lojistik attrition alan ordular başlık satırında `Lojistik zayiat` metni gösterir | `army_panel.go` |
