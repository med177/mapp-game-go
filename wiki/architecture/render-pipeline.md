...
Kara bölge paneli de deniz paneliyle aynı komşu başlığını (`Komşu Bölgeler`) içerir; komşu listesi bina grid'i ve aksiyon barının altındaki panel-local scroll viewport'unda gösterilir, deniz komşuları mavi tonla ayrıştırılır (`internal/render/panel.go`).
