...
| 7 | Diplomasi paneli (Tab) — tam ekran overlay; history panelinde `Gelen / Giden / Tümü` ile `Barış / Ticaret / İttifak / Savaş` filtreleri, kart üstü küçük aksiyon ikonları ve sonuç rozetleri var; history kartları ilgili teklif sayfasına hızlı geçiş sağlar | `diplom.go`, `renderer.go`, `cursor.go` |
...
- confirm / war confirm / battle plan / event detail / historical event modal yüzeyleri
