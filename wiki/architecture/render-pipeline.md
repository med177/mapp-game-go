...
Pazar sekmesinin kontrol satırındaki `Oto. Tahıl İhracı: AÇIK/KAPALI` butonu aynı ticaret paneli rect/hit-test akışıyla `ActionToggleAutoGrainExport` üretir.
