...
| Açılış kamera zoom ayarı | ✅ | İlk frame `resetCamera()` minimum sığdırma yerine `1.40x` yakın başlar; kampanya daha yakın açılır, sıkışık yerleşim kümeleri daha rahat ayrılır ve fare tekerleğiyle `5.5x` seviyesine kadar daha derin yakınlaşma yapılabilir |
